...
LISTING_FIELDS: list[ListingFieldConfig] = [
    ...
    ListingFieldConfig(
        ...
        gbp_field_mask="phoneNumbers",
        field_type="json",
        transformer="additional_phones",
        ui_component="phones_editor",
        supports_bulk_edit=False,
    ),
    ListingFieldConfig(
        name="special_hours",
        ...
        is_critical=False,
        is_read_only=False,
        gbp_field_mask="specialHours",
        field_type="json",
        transformer="special_hours",
        ui_component="special_hours_editor",
        supports_bulk_edit=False,
    ),
    ListingFieldConfig(
        name="service_items",
        ...
        is_critical=False,
        is_read_only=False,
        gbp_field_mask="serviceItems",
        field_type="json",
        transformer="service_items",
        ui_component="service_items_editor",
        supports_bulk_edit=False,
    ),
    ListingFieldConfig(
        name="open_info",
        ...
        is_critical=False,
        is_read_only=False,
        gbp_field_mask="openInfo",
        field_type="json",
        transformer="open_info",
        ui_component="open_status_editor",
        supports_bulk_edit=False,
    ),
    ListingFieldConfig(
        name="business_hours",
