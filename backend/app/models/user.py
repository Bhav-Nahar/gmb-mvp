...
class User(Base):
    ...
    # Owner's contact number, captured at onboarding (gate before the audit) so sales can
    # follow up. Nullable: legacy users predate the field; new signups fill it via the
    # required onboarding modal. Surfaced in the super-admin panel.
