...
app.include_router(cseo.public_router, prefix="/api/v1/public/cseo", tags=["Public cSEO"])
app.include_router(cseo.admin_router, prefix="/api/v1/admin/cseo", tags=["Admin cSEO"])
app.include_router(cityseo.admin_router, prefix="/api/v1/admin/cityseo", tags=["Admin citySEO"])
